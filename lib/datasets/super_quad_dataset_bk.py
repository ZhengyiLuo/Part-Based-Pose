...
class SuperQuadDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            depth = np.load(('{}-depth.npz'.format(self.data_list[index])))
        ...
        target_t = np.squeeze(np.array([meta['poses'][:, 3:4].flatten()]))
        ...
        img, depth, target_r, target_t, pose, quad_rs, quad_ts, cam = img, \
        ...
        return img, depth, target_r, target_t, pose, quad_rs, quad_ts, cam 
...
if __name__ == "__main__":
    ...
    dataset_info = {
        ...
        "data_root": "/hdd/zen/data/Reallite/chair_reallite1/chair_ycb",
    ...
    for i, data in enumerate(loader):
        imgs, depth, target_r, target_t, pose, quad_rs, quad_ts, cam  = data
