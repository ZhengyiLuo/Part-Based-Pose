...
class GeometricPrimitive(nn.Module):
    ...
    def _update_params(self):
        # self.add_module("layer0", self._primitive_params["shapes"])
        # self.add_module("layer1", self._primitive_params["rotations"])
        # self.add_module("layer2", self._primitive_params["translations"])
        # self.add_module("layer3", self._primitive_params["probs"])
        # self.add_module("layer4", self._primitive_params["sizes"])
        # self.add_module("layer5", self._primitive_params["deformations"])
